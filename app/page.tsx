...
import { getPopularMovies, getTrendingMovies, MovieItem } from './services/mediaService';
          ...
          <div className="relative h-[500px] rounded-b-3xl overflow-hidden mb-16">
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-8 md:p-16">
              ...
              <div>
                ...
                <p className="text-slate-200 mb-2 text-lg">{item.releaseDate}</p>
                <p className="text-amber-400 font-semibold mb-6 text-lg">⭐ {item.rating}/10</p>
                <p className="text-slate-300 max-w-2xl mb-8 text-base leading-relaxed line-clamp-3">{item.overview}</p>
