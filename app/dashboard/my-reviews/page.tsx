    ...
    <div className="min-h-screen pb-12">
      <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="py-8">
          ...
          <p className="text-slate-400">View and manage all your reviews here</p>
        </div>

        <div className="grid grid-cols-1 gap-6">
          <div className="bg-slate-800/30 border border-white/5 rounded-xl p-8 text-center">
            <p className="text-slate-400 text-lg mb-4">Your reviews are displayed in the dashboard</p>
